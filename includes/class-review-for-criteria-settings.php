 ...
 * Review for criteria.
 *
 * @package   Review_For_Criteria_Settings
 * @author    Your Company
 * @license   GPL-2.0+
 ...
 * Plugin Settings
 */
class Review_For_Criteria_Settings
{
     ...
     * @var      array
     */
    public static $settings_group_id = 'review-for-criteria-settings';
    ...
    public static $settings_tabs = array(
        'rfc_first_tab'  => 'First Tab',
        'rfc_second_tab' => 'Second Tab',
        'rfc_third_tab'  => 'Third Tab',
    );
    ...
    private static $plugin_settings = array(
        ...
        array(
            'name'    => 'review_for_criteria_hidden_setting_1',
            'hidden'  => 1,
            'default' => 'Some value',
        ),
        array(
            'name'    => 'review_for_criteria_hidden_setting_2',
            'hidden'  => 1,
            'default' => 200,
        ),
        ...
        array(
            'name'    => 'review_for_criteria_dropdown_1',
        ...
        /* === Section Two === */
        array(
            'name'    => 'review_for_criteria_radio_1',
        ...
        array(
            'name'    => 'review_for_criteria_checkbox_1',
        ...
        array(
            'name'    => 'review_for_criteria_checkbox_2',
        ...
        array(
            'name'    => 'review_for_criteria_textarea_1',
...
Mauris lectus augue, mollis eget ultricies quis, gravida vitae mauris.
        ...
        array(
            'name'    => 'review_for_criteria_password_2',
        ...
        /* === Section Four === */
        array(
            'name'    => 'review_for_criteria_dropdown_2',
        ...
        array(
            'name'    => 'review_for_criteria_radio_2',
        ...
        /* === Section Five === */
        array(
            'name'    => 'review_for_criteria_colorpicker_1',
        ...
        array(
            'name'    => 'review_for_criteria_colorpicker_2',
        ...
        array(
            'name'    => 'review_for_criteria_colorpicker_3',
        ...
        /* === Section Six === */
        array(
            'name'    => 'review_for_criteria_text_upload_1',
        ...
        array(
            'name'    => 'review_for_criteria_html_1',
            'title'   => 'HTML Example',
            'section' => 'section_six',
            'field'   => array(
                'type'        => 'html',
    ...
    public function admin_options_init()
    {
        ...
        foreach (self::$settings_sections as $section_id => $section) {
            add_settings_section($section_id, __($section['title'], 'review-for-criteria'), array($this, 'sections_callback'), $section['tab']);
        }
...
<p><?php _e(self::$settings_sections[$section_id]['description'], 'review-for-criteria');?></p>
<?php   }
        }
    }
