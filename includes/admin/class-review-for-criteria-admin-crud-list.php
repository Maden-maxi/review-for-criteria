 ...
 * Review for criteria.
 *
 * @package   Review_For_Criteria_Admin_CRUD_List
 * @author    Your Company
 * @license   GPL-2.0+
...
class Review_For_Criteria_Admin_CRUD_List extends WP_List_Table
{
    ...
    {
        parent::__construct([
            'singular' => __('Entry Name', 'review-for-criteria'),
            'plural'   => __('Entry Names', 'review-for-criteria'),
            'ajax'     => false,
        ]);
    }
    ...
    {
        global $wpdb;
        $sql = 'SELECT * FROM ' . Review_For_Criteria_DB::get_table_name();
    ...
    public static function delete_entry($id)
    {
        global $wpdb;
        $wpdb->delete(
            Review_For_Criteria_DB::get_table_name(),
            ['id' => $id],
            ['%d']
        );
    }
    ...
    {
        global $wpdb;
        $sql = 'SELECT COUNT(*) FROM ' . Review_For_Criteria_DB::get_table_name();
    ...
    {
        _e('No entries found.', 'review-for-criteria');
    }
    ...
    public function column_title($item)
    {
        ...
        $actions = array(
            'edit'   => sprintf('<a href="?page=%s&action=edit&id=%s">%s</a>', 'review-for-criteria-entries-view', $item['id'], __('Edit')),
        ...
        return sprintf('<a href="?page=%1$s&id=%2$s" class="row-title">%3$s</a> %4$s',
            /*$1%s*/'review-for-criteria-entry-edit',
            /*$2%s*/$item['id'],
            /*$3%s*/$item['title'],
    ...
    public function get_columns()
    {
        $columns = [
            ...
            'title'     => __('Title', 'review-for-criteria'),
            'id'        => __('Entry ID', 'review-for-criteria'),
            'shortcode' => __('Shortcode', 'review-for-criteria'),
        ];
        return $columns;
    }
