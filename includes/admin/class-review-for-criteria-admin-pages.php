 ...
 * Review for criteria.
 *
 * @package   Review_For_Criteria_Admin_Pages
 * @author    Your Company
 * @license   GPL-2.0+
...
class Review_For_Criteria_Admin_Pages
{
    ...
    public function enqueue_admin_css_js()
    {
        ...
        // Main Plugin Page
        if ($this->plugin_screen_hook_suffix['review_for_criteria'] == $screen->id) {
            /* Admin Styles */
    ...
    public function add_plugin_admin_menu()
    {
         ...
         *
         */
        $this->plugin_screen_hook_suffix['review_for_criteria'] = add_menu_page(
            __('Review for criteria', 'review-for-criteria'),
            __('Review for criteria', 'review-for-criteria'),
            'manage_options',
