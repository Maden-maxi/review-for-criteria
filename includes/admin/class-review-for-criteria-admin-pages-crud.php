 ...
 * Review for criteria.
 *
 * @package   Review_For_Criteria_Admin_Pages_CRUD
 * @author    Your Company
 * @license   GPL-2.0+
...
class Review_For_Criteria_Admin_Pages_CRUD
{
    ...
    public function add_plugin_admin_menu()
    {
        ...
        $this->plugin_screen_hook_suffix['entries_view'] = add_menu_page(
            __('Manage Entries', 'review-for-criteria'),
            __('Entries', 'review-for-criteria'),
            'manage_options',
        ...
        $this->plugin_screen_hook_suffix['entry_add'] = add_submenu_page(
            $this->plugin_slug . '-entries-view',
            __('Add New Entry', 'review-for-criteria'),
            __('Add New', 'review-for-criteria'),
            'manage_options',
    ...
    public function display_plugin_page_entries_view()
    {
        if (isset($_GET['action']) && ($_GET['action'] == 'edit')) {
            ...
            $review_for_criteria_list_table = new Review_For_Criteria_Admin_CRUD_List();
            $review_for_criteria_list_table->prepare_items();
    ...
    public function display_plugin_page_entry_edit()
    {
        ...
        if (isset($_GET['id']) && $_GET['id'] != 0) {
            $entry_data = $wpdb->get_row('SELECT * FROM ' . Review_For_Criteria_DB::get_table_name() . ' WHERE id = ' . $_GET['id']);
            // get data
