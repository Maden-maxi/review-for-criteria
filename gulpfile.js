...
/** CONFIG **/
var pluginConfig = {
    'CONF Plugin Name': 'Review for criteria', // User friendly plugin name
    'CONF_Plugin_Link': 'http://yourcompany.com/plugins/review-for-criteria', // Plugin homepage URL
    ...
    'CONF_Plugin_Copyright': '2018 Your Company', // Use your own name or your company name
    'plugin-name': 'review-for-criteria', // Plugin slug
    'Plugin_Name': 'Review_For_Criteria', // Classes prefix
    'plugin_name': 'review_for_criteria', // plugin identifier
    'plugin_prefix': 'rfc' // plugin identifier
};
