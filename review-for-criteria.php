...
require_once plugin_dir_path(__FILE__) . 'includes/class-review-for-criteria-settings.php';
...
/* ----- Plugin Module: CPT ----- */
require_once plugin_dir_path(__FILE__) . 'includes/cpt/class-review-for-criteria-cpt.php';
...
require_once plugin_dir_path(__FILE__) . 'includes/class-review-for-criteria-db.php';
...
require_once plugin_dir_path(__FILE__) . 'includes/class-review-for-criteria.php';
...
if (is_admin() && (!defined('DOING_AJAX') || !DOING_AJAX)) {
    ...
    /* ----- Plugin Module: CRUD ----- */
    require_once plugin_dir_path(__FILE__) . 'includes/admin/class-review-for-criteria-admin-crud-list.php';
    /* ----- Module End: CRUD ----- */

    require_once plugin_dir_path(__FILE__) . 'includes/admin/class-review-for-criteria-admin.php';
    add_action('plugins_loaded', array('Review_For_Criteria_Admin', 'get_instance'));

    require_once plugin_dir_path(__FILE__) . 'includes/admin/class-review-for-criteria-admin-pages.php';
    add_action('plugins_loaded', array('Review_For_Criteria_Admin_Pages', 'get_instance'));

    require_once plugin_dir_path(__FILE__) . 'includes/admin/class-review-for-criteria-admin-pages-crud.php';
    add_action('plugins_loaded', array('Review_For_Criteria_Admin_Pages_CRUD', 'get_instance'));

    require_once plugin_dir_path(__FILE__) . 'includes/admin/class-review-for-criteria-admin-pages-settings.php';
...
// Admin Side
require_once plugin_dir_path(__FILE__) . 'includes/shortcode/class-review-for-criteria-shortcode-admin.php';
add_action('plugins_loaded', array('Review_For_Criteria_Shortcode_Admin', 'get_instance'));

// Public Side
require_once plugin_dir_path(__FILE__) . 'includes/shortcode/class-review-for-criteria-shortcode-public.php';
...
/* ----- Plugin Module: AJAX ----- */
require_once plugin_dir_path(__FILE__) . 'includes/class-review-for-criteria-ajax.php';
